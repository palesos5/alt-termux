DISTRO_NAME="OpenWrt"
DISTRO_COMMENT="OpenWrt 24.10.5 - Embedded Linux distribution for routers and embedded devices"
...
distro_setup() {
	...
	run_proot_cmd mkdir -p /dev /proc /sys /tmp /var/run /var/lock
...
EOF
	...
	# Initialize opkg package manager directories
	run_proot_cmd mkdir -p /var/opkg-lists /var/lock
